...
func _turkish_messages() -> Dictionary:
	return {
		...
		"MISSION_NET_REWARD": "Net Kazanç: +%d ₺",
		"MISSION_FINANCIAL_DETAILS": "Gelir: %d ₺ • Sefer Masrafı: %d ₺",
		"MISSION_RESULT_TITLE": "Teslimat tamamlandı",
		"MISSION_RESULT_INCOME": "Gelir",
		"MISSION_RESULT_COST": "Sefer Masrafı",
		"MISSION_RESULT_NET": "Net Kazanç",
		"REMAINING": "Kalan: %s",
		"SHIP_DEFAULT": "Gemi",
		...
		"AUTOMATION_CONTRACTS_REQUIRED": "Otomatik Görev · Büyük Kontrat %d/%d",
		"MISSION_LARGE_CONTRACT": "BÜYÜK KONTRAT · %d TESLİMAT",
		"MISSION_CONTRACT_PROGRESS": "Büyük Kontrat · Teslimat %d/%d",
		...
		"INSTRUCTION_LARGE_CONTRACT_STARTED": "Büyük Kontrat: 2 teslimat, ödeme finalde. Başlamış kontrat oyun kapalıyken ilerler.",
		"INSTRUCTION_MISSION_COMPLETED": "Teslimat tamamlandı · Net Kazanç +%d ₺.",
		"INSTRUCTION_AUTOMATION_READY": "%s otomatik göreve hazır · Filo panelinden %d ₺ karşılığında açabilirsin.",
		"INSTRUCTION_LARGE_CONTRACTS_UNLOCKED": "Büyük Kontratlar açıldı · Görev tekliflerinde altın işaretli uzun rotaları ara.",
...
func _english_messages() -> Dictionary:
	...
	messages.merge({
		...
		"FLEET_HELP_MESSAGE": "Select, track and improve your ship.\nSpeed shortens trips; capacity increases cargo.\nAuto Dispatch: Lv.5 + 2 Large Contracts + 5,000 ₺. It only picks new jobs while the game is open.",
		"FLEET_HELP_OK": "Got it",
		"SHIP_SHOP_TITLE": "Buy Ship",
		"MISSION_OFFERS_TITLE": "Cargo at %s Port", "MISSION_WAITING": "Waiting for missions...",
		"MISSION_NET_REWARD": "Net Earnings: +%d ₺",
		"MISSION_FINANCIAL_DETAILS": "Income: %d ₺ • Voyage Cost: %d ₺",
		"MISSION_RESULT_TITLE": "Delivery complete",
		"MISSION_RESULT_INCOME": "Income",
		"MISSION_RESULT_COST": "Voyage Cost",
		"MISSION_RESULT_NET": "Net Earnings",
		...
		"AUTOMATION_CONTRACTS_REQUIRED": "Auto Dispatch · Large Contracts %d/%d",
		"MISSION_LARGE_CONTRACT": "LARGE CONTRACT · %d DELIVERIES",
		"MISSION_CONTRACT_PROGRESS": "Large Contract · Delivery %d/%d",
		...
		"INSTRUCTION_LARGE_CONTRACT_STARTED": "Large Contract: 2 deliveries, paid at the end. Active contracts progress while closed.",
		"INSTRUCTION_MISSION_COMPLETED": "Delivery complete · Net Earnings +%d ₺.",
		"INSTRUCTION_AUTOMATION_READY": "%s is ready for Auto Dispatch · Unlock it from the Fleet panel for %d ₺.",
		"INSTRUCTION_LARGE_CONTRACTS_UNLOCKED": "Large Contracts unlocked · Look for gold-marked long routes in mission offers.",
