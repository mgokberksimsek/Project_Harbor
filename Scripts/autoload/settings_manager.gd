...
func _turkish_messages() -> Dictionary:
	return {
		...
		"FLEET_HELP_MESSAGE": "Gemilerini buradan seçip geliştirebilirsin.\nHız seferleri kısaltır; kapasite daha çok yük taşır.\nİleri seviyelerde Otomatik Görev seçeneğiyle gemiler uygun işleri kendileri seçebilir.",
		...
		"AUTOMATION_UPGRADES_REQUIRED": "Otomatik Görev · Geliştirme %d/%d",
		...
		"PORT_CANAKKALE": "Çanakkale", "PORT_TRABZON": "Trabzon",
...
func _english_messages() -> Dictionary:
	...
	messages.merge({
		...
		"FLEET_HELP_MESSAGE": "Select and improve your ships here.\nSpeed shortens voyages; capacity carries more cargo.\nAt higher levels, Auto Dispatch lets ships choose suitable jobs on their own.",
		...
		"AUTOMATION_UPGRADES_REQUIRED": "Auto Dispatch · Upgrades %d/%d",
		...
		"PORT_CANAKKALE": "Canakkale", "PORT_TRABZON": "Trabzon",
